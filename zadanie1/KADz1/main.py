...
dane = pd.read_csv('Dane_Irysy.csv', header=None, names=["Długość działki kielicha", "Szerokość działki kielicha",
                                                  "Długość płatka", "Szerokość płatka", "ID"])
Dlug_dzial_kiel = pd.read_csv(r'Dane_Irysy.csv', header=None, usecols=[0])  # kolumna z wartościami długości działki kielicha
Szer_dzial_kiel = pd.read_csv(r'Dane_Irysy.csv', header=None, usecols=[1])  # kolumna z wartościami szerokości działki kielicha
Dlug_plat = pd.read_csv(r'Dane_Irysy.csv', header=None, usecols=[2])        # kolumna z wartościami długości płatka
Szer_plat = pd.read_csv(r'Dane_Irysy.csv', header=None, usecols=[3])        # kolumna z wartościami szerokości płatka
ID_Gat = pd.read_csv(r'Dane_Irysy.csv', header=None, usecols=[4])           # kolumna z ID poszczególnych gatunków
