...
def tabela1(tabela_ID_gatunkow = None):
    ...
    # tablica "dane" to dwuwymiarowa tabela danych
    ...
    # przy uzyciu struktury DataFrame można
    # przeniesc wszystkie pożądane dane bezposrednio do tabeli
...
# Zamiana na stosowaną w Polsce notację, czyli nie "." tylko "," w liczbach zmiennoprzecinkowych  ( .replace(".",",") )
